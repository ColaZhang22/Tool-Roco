...
def evaluateCurrentStep(all_json, metrics, tools_info):
    ...
    for index in range(len(all_json)):
        ...
        if all_json[index]["Tools Calling"] == 1:
            ...
            for agent in all_json[index]["Response"]:
                tool_match = re.search(r"<tool calling>(.*?)</tool calling>", all_json[index]["Response"][agent], re.DOTALL)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_path", type=str, default="/Users/zhangke/Desktop/Experiment/aamas_pack_gpt_4o_mini_dec")

...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_name", "-rn", type=str, default="aamas_sort_gpt_4o_mini_dec_org")
    ...
    parser.add_argument("--comm_mode", type=str, default="auto_organization", choices=["decentralized", "auto_organization"])
    ...
    parser.add_argument("--load_run_name", "-lr", type=str, default="sort")

...
class LLMRunner:
    def __init__(
        ...
        print(f"---------------llm_comm_mode: {self.llm_comm_mode }------------------")
        print(f"---------------open source model: {self.model_path }------------------")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_name", "-rn", type=str, default="cabinet_Llama-3-8B-Instruct_central_self_organization")
